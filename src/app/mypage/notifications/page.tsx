...
import { Bell, ChevronLeft, Moon, Smartphone } from "lucide-react";
...
export default function NotificationsPage() {
  ...
  const SettingRow = ({ 
    ...
    <div className="flex items-center justify-between py-6 border-b border-gray-50 dark:border-gray-800 last:border-0 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors px-4 -mx-4 rounded-xl">
      <div className="flex gap-4">
        ...
        <div className="flex flex-col gap-1">
          <span className="text-[15px] font-bold text-gray-900 dark:text-gray-100">{title}</span>
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      {/* Sticky Header */}
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800">
        <div className="mx-auto max-w-2xl px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">알림 설정</h1>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-2xl px-4 pt-8">
        <div className="flex flex-col gap-2 mb-8">
          <h2 className="text-[13px] font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider">주요 알림 제어</h2>
          <p className="text-[14px] text-gray-500 font-medium">서비스 이용에 필요한 알림들을 설정해보세요.</p>
        </div>

        <section className="bg-white rounded-2xl border border-gray-100 dark:border-transparent dark:bg-gray-900 p-2 shadow-sm">
        ...
        <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800">
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[14px] font-bold text-gray-700 dark:text-gray-300">기기 알림 설정 안내</span>
